import { BasicMetaSysProps, DefaultElements, GetCommentParams, GetEntryParams, GetSpaceEnvironmentParams, Link, MakeRequest, SysLink } from '../common-types';
...
export declare type GetCommentParentEntityParams = GetSpaceEnvironmentParams & ({
...
export declare type GetManyCommentsParams = GetEntryParams | GetCommentParentEntityParams;
export declare type CreateCommentParams = GetEntryParams | GetCommentParentEntityParams;
